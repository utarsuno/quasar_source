...
import json
import uuid
from quasar_libraries_and_scripts.servers.web_sockets import web_socket_consumer_abstraction as wsc
...
class ConsumerManager(wsc.AsyncWebsocketConsumer):
	"""Base handler for web sockets."""

	def __init__(self, scope):
		super().__init__(scope)


class ConsumerManager2(AsyncWebsocketConsumer):
