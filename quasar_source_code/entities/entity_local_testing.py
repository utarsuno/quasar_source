...
homework220_1 = e.EntityTask('First homework due second week wednesday', math_220_homework)
homework220_1.due_date = ta.get_specific_day(2017, 'Sep', 6)
homework220_1.description = '[1.1] - {1-10, 15}, [1.2] - {1,3,5,9,11,20}, [1.3] - {1,5,7}'

homework220_2 = e.EntityTask('Second homework due third week wednesday', math_220_homework)
homework220_2.due_date = ta.get_specific_day(2017, 'Sep', 13)
homework220_2.description = '[1.4] - {1, 7, 9*, 11*}, [2.1, 2.2] - {2.2: 2, 3, 4, 7}'

homework220_3 = e.EntityTask('Third homework due fourth week wednesday', math_220_homework)
...
homework220_4 = e.EntityTask('Fourth homework due fifth week wednesday', math_220_homework)
...
homework220_5 = e.EntityTask('Fifth homework due sixth week wednesday', math_220_homework)
...
homework220_6 = e.EntityTask('Sixth homework due seventh week wednesday', math_220_homework)
homework220_6.due_date = ta.get_specific_day(2017, 'Oct', 11)
homework220_6.description = '[4.4] - {1, 2, 7, 10, 12, 19, 27, 30}'

homework220_7 = e.EntityTask('Seventh homework due eighth week wednesday', math_220_homework)
...
homework220_8 = e.EntityTask('Eighth homework due ninth week wednesday', math_220_homework)
...
homework220_9 = e.EntityTask('Ninth homework due tenth week wednesday', math_220_homework)
...
homework220_10 = e.EntityTask('Tenth homework due eleventh week wednesday', math_220_homework)
...
homework220_11 = e.EntityTask('Eleventh homework due twelve week wednesday', math_220_homework)
homework220_11.due_date = ta.get_specific_day(2017, 'Nov', 15)
homework220_11.description = '[5.1, 5.2] - {5.2: 1, 3, 4, 7}'

homework220_12 = e.EntityTask('Thirteenth homework due fourteenth week wednesday', math_220_homework)
...
homework220_13 = e.EntityTask('Fourteenth homework due fifteenth week wednesday', math_220_homework)
...
homework220_14 = e.EntityTask('Fifteenth homework due sixteenth week wednesday', math_220_homework)
