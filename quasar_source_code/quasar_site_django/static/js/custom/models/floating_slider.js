...
FloatingSlider.prototype = {
    ...
    __init__: function(slider_title, current_value, minimum_value, maximum_value, width, position, normal, world) {
        ...
        this.maximum_value_label.update_position_and_normal(this.get_position_on_slider_based_off_percentage(1, 0, -40, 0), this.normal);

        // Slider Title.
        this.slider_floating_title = new Floating2DText(this.width / 2.0, this.slider_title, TYPE_TITLE, this.world.scene);
        this.slider_floating_title.update_position_and_normal(this.get_position_on_slider_based_off_percentage(.5, 0, -40, 0), this.normal);
