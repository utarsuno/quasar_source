...
if(this.disengage_function!==null){this.disengage_function();}};this.is_engaged=function(){return this.being_engaged_with;};this.engage=function(){this.being_engaged_with=true;if(this.engable){this.state_change_engage(true);}
