...
function EntityFieldCreator(base_wall, entity_creator_or_editor) {
    this.__init__(base_wall, entity_creator_or_editor);
}

EntityFieldCreator.prototype = {

    __init__: function(base_wall, entity_creator_or_editor) {
