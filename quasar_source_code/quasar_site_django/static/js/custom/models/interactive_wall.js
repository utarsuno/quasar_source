...
InteractiveWall.prototype = {
    ...
    __init__: function(w, h, position, look_at_normal, scene) {
        ...
        var close_button_look_at = new THREE.Vector3(this.look_at.x + this.width - this.close_button.width, this.look_at.y + this.height / 2 - this.close_button.height / 2, this.look_at.z + 2)
    ...
    add_title: function(title) {
        ...
        var title_position = this.get_position_for_row(-this.width / 4, -this.title.height / 2, 0, 1)
