...
FloatingWall.prototype = {
    ...
    get_parametric_equation: function() {
        return [this.normal.x, this.normal.y, this.normal.z, -1.0 * (this.normal.x * this.object3D.position.x + this.normal.y * this.position.object3D.y + this.normal.z * this.position.object3D.z)];
    },
