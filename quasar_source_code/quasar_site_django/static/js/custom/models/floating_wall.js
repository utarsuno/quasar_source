...
FloatingWall.prototype = {
    ...
    add_3d_title: function(title_name) {
        ...
        var x_shift    = this.get_relative_x_shift(this.floating_3d_title.width / 2);
        var y_position = this.get_position_for_row(x_shift.x, x_shift.y, x_shift.z, 0);
        var look_at    = this.get_look_at_for_row(x_shift.x, x_shift.y, x_shift.z, 0);
