...
return null;},save_changes_result:function(){if(arguments[1]===SERVER_REPLY_GENERIC_YES){arguments[0].needs_to_be_saved=false;}else{l('Error saving entity : ');l(arguments[0]);}},update_server_and_database:function(){var username=ENTITY_OWNER.get_username();var password=ENTITY_OWNER.get_password();for(var e=0;e<this.entities.length;e++){if(this.entities[e].needs_to_be_saved){this.post_save_entity.perform_post({'username':username,'password':password,'save_data':JSON.stringify(this.entities[e].get_all_properties())},this.save_changes_result.bind(this,this.entities[e]));}}}};