...
Player.prototype={owner:null,mouse_locked:null,logged_in:null,engaged:null,camera:null,renderer_api:null,pointer_lock_api:null,fps_controls:null,data_display:null,key_down_ctrl:null,key_down_d:null,__init__:function(renderer_api){this.renderer_api=renderer_api;this.camera=this.renderer_api.camera;this.fps_controls=new FPSControls(this.camera);this.pointer_lock_api=new PointerLockAPI(this.fps_controls);this.data_display=new DataDisplay(this.fps_controls);this.key_down_ctrl=false;this.key_down_d=false;document.addEventListener('keydown',this.on_key_down.bind(this),false);document.addEventListener('keyup',this.on_key_up.bind(this),false);this.logged_in=false;this.engaged=false;MANAGER_WORLD.set_player(this);this.web_socket_client=new WebSocketClient();this.owner_name=null;this.currently_fullscreen=false;},send_chat_message:function(chat_message){if(!is_defined(this.owner_name)){this.owner_name=MANAGER_ENTITY.get_owner_entity().get_value('owner_username');}
this.web_socket_client.send_chat_message(chat_message);},log_out:function(){l('LOG OUT HERE!!!!');MANAGER_ENTITY.clear_all();MANAGER_WORLD.world_home.loaded_entities=false;this.owner=null;MANAGER_WORLD.set_current_world(MANAGER_WORLD.world_login);this.logged_in=false;},get_username:function(){return this.owner.username;},get_password:function(){return this.owner.password;},try_to_send_position_update_to_server:function(){var position=this.get_position();var position_string=''+position.x.toString()+','+position.y.toString()+','+position.z.toString();var position_was_different=false;var look_at_was_different=false;if(is_defined(this.previous_position_string)){if(position_string!==this.previous_position_string){position_was_different=true;}}
