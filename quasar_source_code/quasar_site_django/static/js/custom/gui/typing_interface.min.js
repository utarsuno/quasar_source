...
MANAGER_WORLD.player.send_chat_message(current_input);}},add_server_message:function(server_message){this.add_message('server : '+server_message,MESSAGE_TYPE_SERVER);}};