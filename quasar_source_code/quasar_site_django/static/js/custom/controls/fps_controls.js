...
FPSControls.prototype = {
    ...
    __init__: function(camera) {
        ...
        this.mouse_movement_x_buffer = new SmoothStepLowerLimitZero(this.yaw.rotation.y, 0.025, null, 0)
        this.mouse_movement_y_buffer = new SmoothStepLowerLimitZero(this.pitch.rotation.x, 0.025, null, null)
    ...
    look_at: function(position_vector_to_look_at) {
        ...
        this.mouse_movement_x_buffer.set_value(look_at_angle)
