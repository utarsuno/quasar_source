...
function PlayerState() {
    ...
    this.set_state = function(player_state) {
        ...
        default:
            ...
            //l('PREVIOUS STATE WAS :');
            //l(this.previous_state);
            if (this.previous_state === PLAYER_STATE_LOADING || this.previous_state === 2) {
...
WorldManager.prototype = {
    ...
    update: function(delta) {
        ...
        if (!this.player_cursor._currently_engaged) {
            // Don't update interactive objects during a transition or during chat typing.
            if (!MANAGER_RENDERER.in_transition || CURRENT_PLAYER.current_state === 4) {
...
$_QE.prototype.ButtonState = function() {
    ...
    this._icon = new FloatingIcon(this.world, 5, 32, COLOR_RED, true);
    ...
    this.disable = function() {
        this._enabled = false;
        this._icon.switch_icon(8);
        this._icon.set_to_visible();
    };

    this.lock = function() {
        this._locked = true;
        this._icon.switch_icon(16);
        this._icon.set_to_visible();
    };
...
$_QE.prototype.SpritesheetManager = function() {
    this.get_icon_material = function(icon) {
        this._shader_material = QE.manager_shaders.get_shader_material_abstraction('sm3');
    ...
    this.load_icon_sprite_sheet = function() {
        this.texture = QE.manager_textures.get_texture('a.png');
...
$_QE.prototype.ShaderManager = function(engine) {
    ...
    this._assets['sm3'] = null;

    this._assets['s1'] = this._shader_spritesheet_fragment;
    this._assets['s2']   = this._shader_spritesheet_vertex;
    this._assets['s3']  = this._shader_transition_fragment;
    this._assets['s4']    = this._shader_transition_vertex;
    this._assets['s5']       = this._shader_film_fragment;
    this._assets['s6']         = this._shader_film_vertex;
...
$_QE.prototype.ShaderMaterialNoise = function() {
    $_QE.prototype.ShaderMaterialAbstraction.call(this, 's6', 's5');
...
$_QE.prototype.ShaderMaterialSpriteSheet = function() {
    $_QE.prototype.ShaderMaterialAbstraction.call(this, 's2', 's1');
    this.texture = QE.manager_textures.get_asset('a.png');
...
$_QE.prototype.ShaderMaterialTransition = function() {
    $_QE.prototype.ShaderMaterialAbstraction.call(this, 's4', 's3');
    this.texture = QE.manager_textures.get_asset('b.png');
