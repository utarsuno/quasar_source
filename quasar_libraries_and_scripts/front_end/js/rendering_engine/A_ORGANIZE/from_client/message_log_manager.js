...
$_QE.prototype.ClientMessageLogManager = function() {

    // Inherit.
    QE.ClientMessageTyping.call(this);

    this.logs = new $_QE.prototype.DomElement('gui_console_logs');
    ...
    this._add_message = function(message, user, color) {
        ...
        this.messages.unshift(new $_QE.prototype.ClientLogMessage(user + ':' + message, color, 0));
