...
$_QE.prototype.ClientDataDisplay = function() {
    this.enabled = true;

    // DOM elements.
    this.element_container = new $_QE.prototype.DomElement('data_display');
    this.element_x_coordinate = new $_QE.prototype.DomElement('x_coordinate');
    this.element_y_coordinate = new $_QE.prototype.DomElement('y_coordinate');
    this.element_z_coordinate = new $_QE.prototype.DomElement('z_coordinate');
    this.element_x_direction = new $_QE.prototype.DomElement('x_direction');
    this.element_y_direction = new $_QE.prototype.DomElement('y_direction');
    this.element_z_direction = new $_QE.prototype.DomElement('z_direction');

    this.has_memory_information = performance.memory;
    if (this.has_memory_information) {
        this.element_heap_size = new $_QE.prototype.DomElement('heap_size');
        this.element_heap_max_size = new $_QE.prototype.DomElement('max_heap_size');
    }

    this.element_geometreis = new QE.DomElement('geometries');
    this.element_textures   = new QE.DomElement('textures');
    this.element_shaders    = new QE.DomElement('shader_programs');
