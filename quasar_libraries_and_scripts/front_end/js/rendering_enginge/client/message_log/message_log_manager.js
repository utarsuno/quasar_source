...
$_CQE.prototype.ClientMessageLogManager = function() {

    // Inherit.
    $_CQE.prototype.ClientMessageTyping.call(this);

    this.logs = new $_CQE.prototype.DomElement('gui_console_logs');
    ...
    this._add_message = function(message, user, color) {
        ...
        this.messages.unshift(new $_CQE.prototype.ClientLogMessage(user + ':' + message, color, 0));
