...
$_CQE.prototype.get_client = function() {
    function Client() {
        this.__init__();
    }
    ...
    Client.prototype = {
        ...
        initialize: function() {
            ...
            // Inherit.
            $_CQE.prototype.ClientCookieManager.call(this);
            $_CQE.prototype.ClientSessionManager.call(this);
            $_CQE.prototype.ClientMessageLogManager.call(this);
        },
        ...
        //window.addEventListener('focus', this.on_window_focus_gain.bind(this));
        //window.addEventListener('blur', this.on_window_focus_loss.bind(this));
        },
