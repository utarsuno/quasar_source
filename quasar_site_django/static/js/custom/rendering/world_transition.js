...
function WorldTransition() {
    ...
    this.set_current_world = function(current_world, previous_world, transition_finished_callback, previous_position_and_look_at) {
        ...
        this._camera_transition.position.set(previous_camera_position.x, previous_camera_position.y, previous_camera_position.z);
        this._camera_transition.lookAt(previous_camera_position.x + previous_camera_look_at.x, previous_camera_position.y + previous_camera_look_at.y, previous_camera_position.z + previous_camera_look_at.z);
        ...
        this.current_transition.start(this.camera, this._camera_transition, transition_finished_callback);
    };
