...
TransitionPair.prototype = {
    ...
    render: function(delta) {
        ...
        if (this.transition == 0 ) {
            ...
            this.renderer_manager.renderer.setClearColor(0xffffff);
            this.renderer_manager.renderer.render(this.scene_new, this.current_camera, this.scene_old.fbo, true);
            this.renderer_manager.renderer.setClearColor(0x111111);
            this.renderer_manager.renderer.render(this.scene_old, this.previous_camera, this.scene_new.fbo, true);
