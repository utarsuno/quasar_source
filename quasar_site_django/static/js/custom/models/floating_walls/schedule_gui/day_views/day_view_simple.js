...
DayViewSimple.prototype = {
    ...
    __init__: function(day_instance, base_wall) {
        ...
        this.day_view.set_attachment_horizontal_offset(position_width * this.day_instance.day_of_the_week, -HALF);
        this.day_view.set_attachment_vertical_offset(position_height * this.day_instance.week_number, -HALF);
