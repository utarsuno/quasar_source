...
ConfirmationPrompt.prototype = {
    ...
    __init__: function(world) {
        ...
        this.button_yes = row.add_button([0, HALF, false], 16, 'yes', this.button_yes_clicked.bind(this));
        this.button_yes.set_foreground_color(COLOR_RED);
        this.button_no  = row.add_button([HALF, 1, false], 16, 'no', this.button_no_clicked.bind(this));
