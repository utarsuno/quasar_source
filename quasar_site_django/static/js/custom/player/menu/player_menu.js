...
PlayerMenu.prototype = {
    ...
    _create_sub_menu_teleport_wall: function(menu_text) {
        ...
        if (this.world !== MANAGER_WORLD.world_settings) {
            ...
            current_button = teleport_row.add_button([0, 1, false], this.text_height, 'Settings', player_action_teleport_to_world.bind(this, MANAGER_WORLD.world_settings));
            current_button.add_icon_left(ICON_SETTINGS);
        }

        if (this.world !== MANAGER_WORLD.world_home) {
            teleport_row = this.teleport_wall.add_row(null);
            current_button = teleport_row.add_button([0, 1, false], this.text_height, 'Home', player_action_teleport_to_world.bind(this, MANAGER_WORLD.world_home));
    ...
    _create_sub_menu_create_wall: function(menu_text) {
        ...
        current_row = this.create_wall.add_row(null);
        current_button = current_row.add_button([0, 1, false], this.text_height, 'Month View', player_action_create_month_view);
        ...
        current_row = this.create_wall.add_row(null);
        current_button = current_row.add_button([0, 1, false], this.text_height, 'Entity Group', player_action_create_entity_group);
        current_button.add_icon_left(ICON_INFORMATION);

        current_row = this.create_wall.add_row(null);
        current_button = current_row.add_button([0, 1, false], this.text_height, 'Picture', player_action_create_picture);
        current_button.add_icon_left(ICON_IMPORT);

        current_row = this.create_wall.add_row(null);
        current_button = current_row.add_button([0, 1, false], this.text_height, 'YouTube Video', player_action_create_new_video);
