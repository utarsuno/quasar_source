...
$_QE.prototype.FactoryBridgedWorker = function (workerFunction, workerExportNames, mainExportNames, mainExportHandles) {
    ...
    let ret = {blobURL: url};//this is useful to know for debugging if you have loads of bridged workers in blobs with random names
    let makePostMessageForFunction = function(name,hasBuffers){
        if (hasBuffers) {
