...
from libraries.code_api.project_abstraction.code_project import CodeProject
...
from libraries.code_api.discrete_projects.rendering_engine import javascript_manager as jsm
...
class QuasarRenderingEngineBuilder(object):
	...
	def _load_project(self):
		...
		self.css.add_base_code_directory(CodeDirectory('/quasar/libraries/front_end/css'))
		self.css.load_all_content()

		# HTML
		self.html = ProjectComponent('quasar_rendering_engine_html')
		self.html.add_extension_to_ignore('.min')
		self.html.add_base_code_directory(CodeDirectory('/quasar/libraries/front_end/html/quasar_nexus'))
		...
		# Assets
		#self.assets = ProjectComponent('quasar_rendering_engine_assets')
		#self.assets.add_base_code_directory(CodeDirectory('/quasar/source/assets/front_end'))
		#self.assets.load_all_content()
