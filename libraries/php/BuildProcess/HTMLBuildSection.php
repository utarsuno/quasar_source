...
class HTMLBuildSection extends AssetBuildSection {
    ...
    protected function handle_step_processed(EntityFile $file, string $output_file_path): ?EntityFile {
        ...
        $path_processed = $this->config_get(AssetBuildSection::CONFIG_KEY_DIR_OUTPUT) . STR::replace(PATH::get_file_full_name($file_path), UFO::EXTENSION_HTML, '.processed' . UFO::EXTENSION_HTML);
