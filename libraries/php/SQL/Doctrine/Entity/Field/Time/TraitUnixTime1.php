...
namespace QuasarSource\SQL\Doctrine\Entity\Field\Time;
 ...
 * @package QuasarSource\SQL\Doctrine\Entity\Field\Time
 */
trait TraitUnixTime1 {
    use TraitUnixTime0;
     ...
     * @return self
     */
    public function setUnixTime0(int $unix_time1=-1): self {
        if ($unix_time1 === -1) {
