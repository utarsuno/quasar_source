...
Object.assign(
    ...
    $_QE.prototype.BooleanFlagsStaticOneBucket.prototype,
    {
        ...
        _set_flags_default_rendering_settings: function() {
            this.flag_set_on(
                QEFLAG_SETTING_AUDIO |
                QEFLAG_SETTING_SHADERS |
                QEFLAG_SETTING_FXAA |
                QEFLAG_SETTING_OUTLINE |
                QEFLAG_SETTING_GRAIN |
                QEFLAG_SETTING_TRANSITION
            );
        },

        _set_flags_required_web_features: function() {
        ...
        _set_flags_optional_web_features: function() {
        ...
        _are_required_features_enabled: function() {
            this._set_flags_default_rendering_settings();
            this._set_flags_required_web_features();
            this._set_flags_optional_web_features();
            return this.flags_are_both_on(QEFLAG_FEATURE_CANVAS, QEFLAG_FEATURE_WEBGL);
        },
