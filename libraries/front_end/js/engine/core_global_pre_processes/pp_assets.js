...
const ASSET_ICON_QUESTION   = 19; // #pre-process_global_constant
const ASSET_ICON_TELEPORT   = 20; // #pre-process_global_constant
const ASSET_ICON_TERMINAL   = 21; // #pre-process_global_constant
const ASSET_ICON_TEXT       = 22; // #pre-process_global_constant
const ASSET_ICON_UNLOCKED   = 23; // #pre-process_global_constant
const ASSET_ICON_VERTICAL   = 24; // #pre-process_global_constant
const ASSET_ICON_VIDEO      = 25; // #pre-process_global_constant
const ASSET_ICON_WARNING    = 26; // #pre-process_global_constant
const ASSET_ICON_WRENCH     = 27; // #pre-process_global_constant
const ASSET_ICON_WRITTING   = 28; // #pre-process_global_constant
