...
$_QE.prototype.WorldState = function(default_world_enter_position, default_world_enter_normal, custom_world_enter_function, custom_world_exit_function) {
    ...
    this.default_world_enter_look_at  = default_world_enter_normal;

    this.player_last_position         = null;
    this.player_last_normal           = null;
    ...
    this.enter_world = function() {
        ...
        if (this.custom_world_enter_function != null) {
    ...
    this.exit_world = function() {
        ...
        if (this.custom_world_exit_function != null) {
    ...
    this._set_player_exit_position_and_look_at = function() {
        ...
        // TODO: used a cached version.
        this.player_last_position         = new THREE.Vector3(p.x, p.y, p.z);
        this.player_last_normal           = new THREE.Vector3(la.x, la.y, la.z);
