...
$_QE.prototype.FloatingElement = function(world, is_root_element) {

    this.is_root_element = is_root_element;

    //$_QE.prototype.FeatureAttachment.call(this, is_root_element);
