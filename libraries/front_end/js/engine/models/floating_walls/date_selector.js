...
DateSelector.prototype = {
    ...
    __init__: function(world, date_selected_callback) {
        ...
        this.wall_date_selector = new FloatingWall(600, 250, null, null, world, false, QE.COLOR_BLACK);
        this.wall_date_selector.add_row(-1).add_text_3D([0, null, false], 32, 'Date Selector', QE.COLOR_YELLOW);
