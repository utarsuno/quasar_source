...
$_QE.prototype.FeatureRow = function(parent_wall, height, y_percentage_position_start) {
    ...
    this.create_icon_left = function(icon_type, color, relative_index) {
        return this.elements.add_element_left(new $_QE.prototype.FloatingIcon(false, icon_type, this.row_height, color), relative_index, true);
    };

    this.create_icon_right = function(icon_type, color, relative_index) {
        return this.elements.add_element_right(new $_QE.prototype.FloatingIcon(false, icon_type, this.row_height, color), relative_index, true);
    };

    this.create_text3d_center = function(text, color, interactive) {
        return this.elements.add_element_center(new $_QE.prototype.Text3D(false, this.row_height, text, interactive), true, true);
    };
