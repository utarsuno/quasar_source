...
$_QE.prototype.CloseButton = function() {
    ...
    this._close_button = new $_QE.prototype.FloatingIconButton(this.world, ASSET_ICON_CROSS, 16, this.force_hide_self_and_all_child_attachments_recursively.bind(this));
    ...
    this._close_button.offset_depth_distance = 2;
