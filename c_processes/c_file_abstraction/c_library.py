...
class CLibrary(object):
	...
	def compile_library(self, input_directory, output_directory):
		"""Compiles the library given the input source code directory and the output directory."""
		print('Compile file test!')
		print(terminal_api.run_terminal_command(['gcc', '-c', self._c_source_file.full_file_path, '-o', output_directory + self._c_source_file.file_name]))
