...
$_NL.prototype.WebsocketMessageHandler = function() {
    ...
    this.send_request_chat = function(m) {
        QE.manager_hud.hud_chat.add_text_line_to_bottom('you: ' + m, QE.COLOR_CANVAS_TEAL);
    ...
    this.send_request_cmd = function(m) {
        QE.manager_hud.hud_chat.add_text_line_to_bottom('cmd: [' + m + ']', QE.COLOR_CANVAS_GREEN);
        this._websocket_manager.send_request(
    ...
    this._on_message_response = function(m) {
        ...
        l(m);
        QE.manager_hud.hud_chat.add_text_line_to_bottom('s: [' + m[_WEB_SOCKET_KEY_DATA] + ']', QE.COLOR_CANVAS_GREEN);
    };
