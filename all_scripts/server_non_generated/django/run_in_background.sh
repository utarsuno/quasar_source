...
print_dashed_line_with_text "run_in_background.sh script start for django on : ${HOST_NAME}"
...
print_dashed_line_with_text "run_in_background.sh script completed for django on : ${HOST_NAME}"
