...
# .__/ \__, |  \ |  |     |     .__/  |  /~~\ |  \  |  
# ----------------------------------------------------------------------------
print_dashed_line_with_text "script{terminate.sh} start on {${CURRENT_USER}-${HOST_NAME}}."
...
# .__/ \__, |  \ |  |     |     |___ | \| |__/ 
# ----------------------------------------------------------------------------
print_dashed_line_with_text "script{terminate.sh} end on {${CURRENT_USER}-${HOST_NAME}}."
