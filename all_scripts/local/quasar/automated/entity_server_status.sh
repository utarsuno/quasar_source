...
# .__/ \__, |  \ |  |     |     .__/  |  /~~\ |  \  |  
# ----------------------------------------------------------------------------
print_dashed_line_with_text "script{entity_server_status.sh} start on {${CURRENT_USER}-${HOST_NAME}}."
...
ssh -tt -i ${QUASAR_PEM_PATH} ${QUASAR_USER}@${QUASAR_IP} -p ${QUASAR_PORT} "${ENTITY_STATUS_SERVER}"
#ssh -tt -i ${QUASAR_PEM_PATH} ${QUASAR_USER}@${QUASAR_IP} -p ${QUASAR_PORT} -e "/home/quasarboi/quasar_project/all_scripts/entity_server/status.sh"

#ssh -i ${QUASAR_PEM_PATH} ${QUASAR_USER}@${QUASAR_IP} -p ${QUASAR_PORT} -e ls
...
# .__/ \__, |  \ |  |     |     |___ | \| |__/ 
# ----------------------------------------------------------------------------
print_dashed_line_with_text "script{entity_server_status.sh} end on {${CURRENT_USER}-${HOST_NAME}}."
