package com.quasar.qdb.server.dbmessage;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.quasar.qdb.server.dbmessage.definedmessages.*;
...
public class DBServerMessageConsumer extends DefaultConsumer {
    ...
    private DBServerMessage parse_server_message(String m) throws Exception {
        int message_type;
    ...
    public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
        ...
        DBServerMessage server_message = null;
        try {
            server_message = this.parse_server_message(message);
        } catch (Exception e) {
            e.printStackTrace();
        }
